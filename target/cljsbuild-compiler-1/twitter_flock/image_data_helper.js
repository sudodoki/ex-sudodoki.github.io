...
twitter_flock.image_data_helper.IPixel = (function (){var obj6374 = {};return obj6374;
})();
...
{throw cljs.core.missing_protocol("IPixel.red",pixel);
}
}
})().call(null,pixel);
}
...
{throw cljs.core.missing_protocol("IPixel.green",pixel);
}
}
})().call(null,pixel);
}
...
{throw cljs.core.missing_protocol("IPixel.blue",pixel);
}
}
})().call(null,pixel);
}
...
{throw cljs.core.missing_protocol("IPixel.alpha",pixel);
}
}
})().call(null,pixel);
}
...
cljs.core.PersistentVector.prototype.twitter_flock$image_data_helper$IPixel$red$arity$1 = (function (a){var a__$1 = this;return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(a__$1,0);
});
cljs.core.PersistentVector.prototype.twitter_flock$image_data_helper$IPixel$green$arity$1 = (function (a){var a__$1 = this;return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(a__$1,1);
});
cljs.core.PersistentVector.prototype.twitter_flock$image_data_helper$IPixel$blue$arity$1 = (function (a){var a__$1 = this;return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(a__$1,2);
});
cljs.core.PersistentVector.prototype.twitter_flock$image_data_helper$IPixel$alpha$arity$1 = (function (a){var a__$1 = this;return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(a__$1,3);
});
...
twitter_flock.image_data_helper.IBitmap = (function (){var obj6376 = {};return obj6376;
})();
...
{throw cljs.core.missing_protocol("IBitmap.width",bitmap);
}
}
})().call(null,bitmap);
}
...
{throw cljs.core.missing_protocol("IBitmap.height",bitmap);
}
}
})().call(null,bitmap);
}
...
{throw cljs.core.missing_protocol("IBitmap.data",bitmap);
}
}
})().call(null,bitmap);
}
...
twitter_flock.image_data_helper.ImageDataSeq.cljs$lang$ctorPrWriter = (function (this__4046__auto__,writer__4047__auto__,opt__4048__auto__){return cljs.core._write(writer__4047__auto__,"twitter-flock.image-data-helper/ImageDataSeq");
});
...
var coll__$1 = this;return cljs.core._nth.cljs$core$IFn$_invoke$arity$3(coll__$1,n,twitter_flock.image_data_helper.empty_pixel);
});
...
var coll__$1 = this;if(cljs.core.counted_QMARK_(self__.arr))
{return cljs.core.ci_reduce.cljs$core$IFn$_invoke$arity$4(self__.arr,f,(self__.arr[self__.i]),(self__.i + 1));
} else
{return cljs.core.ci_reduce.cljs$core$IFn$_invoke$arity$4(coll__$1,f,(self__.arr[self__.i]),0);
}
});
...
var coll__$1 = this;if(cljs.core.counted_QMARK_(self__.arr))
{return cljs.core.ci_reduce.cljs$core$IFn$_invoke$arity$4(self__.arr,f,start,self__.i);
} else
{return cljs.core.ci_reduce.cljs$core$IFn$_invoke$arity$4(coll__$1,f,start,0);
}
});
...
var G__6382 = null;
var G__6382__2 = (function (self__,k){var self____$1 = this;var coll = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$2(coll,k);
});
var G__6382__3 = (function (self__,k,not_found){var self____$1 = this;var coll = self____$1;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(coll,k,not_found);
});
...
;
ImageData.prototype.apply = (function (self__,args6377){var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args6377)));
});
ImageData.prototype.cljs$core$IFn$_invoke$arity$1 = (function (k){var coll = this;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$2(coll,k);
});
ImageData.prototype.cljs$core$IFn$_invoke$arity$2 = (function (k,not_found){var coll = this;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(coll,k,not_found);
});
ImageData.prototype.cljs$core$IAssociative$ = true;
ImageData.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (coll,p__6378){var vec__6379 = p__6378;var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6379,0,null);var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6379,1,null);var coll__$1 = this;return ((x >= 0)) && ((y >= 0)) && ((x < coll__$1.width)) && ((y < coll__$1.height));
});
ImageData.prototype.cljs$core$ILookup$ = true;
ImageData.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (coll,k){var coll__$1 = this;return cljs.core._lookup.cljs$core$IFn$_invoke$arity$3(coll__$1,k,twitter_flock.image_data_helper.empty_pixel);
});
ImageData.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (coll,p__6380,not_found){var vec__6381 = p__6380;var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6381,0,null);var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6381,1,null);var coll__$1 = this;if(((x >= 0)) && ((y >= 0)) && ((x < coll__$1.width)) && ((y < coll__$1.height)))
{return cljs.core._nth.cljs$core$IFn$_invoke$arity$3(coll__$1,(x + (y * coll__$1.width)),not_found);
} else
{return not_found;
}
});
ImageData.prototype.cljs$core$IIndexed$ = true;
ImageData.prototype.cljs$core$IIndexed$_nth$arity$2 = (function (coll,n){var coll__$1 = this;return cljs.core._nth.cljs$core$IFn$_invoke$arity$3(coll__$1,n,twitter_flock.image_data_helper.empty_pixel);
});
ImageData.prototype.cljs$core$IIndexed$_nth$arity$3 = (function (coll,n,not_found){var coll__$1 = this;var pix = coll__$1.data;var offset = (4 * n);if(((n >= 0)) && ((n < cljs.core.count(coll__$1))))
